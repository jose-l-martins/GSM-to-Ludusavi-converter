...
# Debug information
print("Attempting to locate Steam installation path...")
steam_installation_path = get_steam_installation_path()
if steam_installation_path:
    print(f"Steam is installed at: {steam_installation_path}")
else:
    print("Steam not found or installation path not accessible.")
